...
<body>
    <div class="form-container">
        <h1>Sign Up</h1>
        <p>Fill out the form below to sign up for Brainify. Already have an account? <a href="login.php">Log In</a></p>
        <form id="registrationForm" method="POST" action="registration.php">
            <div class="form-group">
                <input type="text" class="form-control-input" id="name" name="name" required placeholder="name">
            </div>
            <div class="form-group">
