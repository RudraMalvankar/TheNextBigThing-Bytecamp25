...
$username = $_SESSION['name']; // Session stores user name

// Use prepared statement to prevent SQL injection
$sqll = "SELECT * FROM entries WHERE user_id = ? AND aural > 0 AND visual > 0";
...
if ($result && $result->num_rows > 0) {
    // Fetch user learning preference
    ...
    header("Location: dashboard.php"); // Redirect if user data is not found
}
